package com.yhs.admin.core.template.config;
...
public class ServiceConfig {
    ...
    public void init() {
        ...
        imports.add("com.yhs.admin.modular." + contextConfig.getModuleName() + ".service.I" + contextConfig.getBizEnBigName() + "Service");
        ...
        this.packageName = "com.yhs.admin.modular." + contextConfig.getModuleName() + ".service";
    }
